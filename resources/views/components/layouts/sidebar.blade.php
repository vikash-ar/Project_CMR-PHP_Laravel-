            ...
            <ul>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ url('addproduct') }}"><i data-feather="plus-square"></i><span>Create
                                    Product</span></a></li>
                        <li><a href="{{ url('categorylist') }}"><i data-feather="codepen"></i><span>Category</span></a>
                        </li>
                        <li><a href="{{ url('brandlist') }}"><i data-feather="tag"></i><span>Brands</span></a></li>
                        <li><a href="{{ url('subcategorylist') }}"><i data-feather="speaker"></i><span>Sub
                                    Category</span></a></li>
                        <li><a href="{{ url('importproduct') }}"><i data-feather="minimize-2"></i><span>Import
                                    Products</span></a></li>
                    </ul>
                </li>
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href="{{ url('saleslist') }}"><i data-feather="shopping-cart"></i><span>Sales</span></a>
                        </li>
                        <li><a href="{{ url('invoicereport') }}"><i
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href="{{ url('purchases') }}"><i
                                    data-feather="shopping-bag"></i><span>Purchases</span></a></li>
                        <li><a href="{{ url('importpurchases') }}"><i data-feather="minimize-2"></i><span>Import
                                    Purchases</span></a></li>
...
<li><a href="{{url('purchasesorderreport')}}"><i data-feather="file-minus"></i><span>Purchase Order</span></a></li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href="{{ url('customerlist') }}"><i data-feather="user"></i><span>Customers</span></a>
                        </li>
                        <li><a href="{{ url('supplierlist') }}"><i data-feather="users"></i><span>Suppliers</span></a>
                        </li>
                        <li><a href="{{ url('userlist') }}"><i data-feather="user-check"></i><span>Users</span></a>
                        </li>
                ...
                <li class="submenu-open">
                    ...
                    <ul>
                        <li><a href="{{ url('salesreport') }}"><i data-feather="bar-chart-2"></i><span>Sales
                                    Report</span></a></li>
                        <li><a href="{{ url('purchaseorderreport') }}"><i data-feather="pie-chart"></i><span>Purchase
                                    report</span></a></li>
                        <li><a href="{{ url('inventoryreport') }}"><i data-feather="credit-card"></i><span>Inventory
                                    Report</span></a></li>
                        <li><a href="{{ url('invoicereport') }}"><i data-feather="file"></i><span>Invoice
                                    Report</span></a></li>
                        <li><a href="{{ url('purchasereport') }}"><i data-feather="bar-chart"></i><span>Purchase
                                    Report</span></a></li>
                        <li><a href="{{ url('supplierreport') }}"><i data-feather="database"></i><span>Supplier
                                    Report</span></a></li>
                        <li><a href="{{ url('customerreport') }}"><i data-feather="pie-chart"></i><span>Customer
                                    Report</span></a></li>
                    </ul>
                </li>
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li class="submenu-open">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="{{ url('login') }}"><i data-feather="log-out"></i><span>Logout</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
